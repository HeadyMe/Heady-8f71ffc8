...
```json
{
  ...
  "Authorization": "Bearer <YOUR_HEADY_API_KEY>",
  "X-Heady-Source": "cloudflare-evaluation",
...
HeadyMCP implements the **Model Context Protocol v1.26.0** standard. To connect any MCP-compatible client:
...
| Tool | Description |
|------|-------------|
| `heady_chat` | AI chat with configurable model, temp, context |
...
*Generated by HeadyMCP v1.0.0 — Routes 100% through Heady AI services*
